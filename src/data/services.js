...
const facialSvgMap = {
    ...
    "Eclora Aesthetics Signature Glow": "/facials/éclora-signature-glow.svg",
...
export const services = [
    ...
    { id: 4, name: "Skin Boosters", description: "Deep hydration therapies for glowing skin", category: "Injectables" },
    ...
    { id: 44, name: "QR678 Hair Growth", description: "Patented hair regrowth  therapy", category: "Hair Treatments" },
    ...
    { id: 47, name: "Hydrafacial", description: "Deep cleansing, exfoliation, and hydration for an instant glow", category: "Facials" },
    { id: 48, name: "Oxyfacial", description: "Oxygen-infused therapy to rejuvenate and brighten skin", category: "Facials" },
];
